const QuestionsArray = [
    {Q: 'OQue é JSX?', R: 'Uma extensão de linguagem do JavaScript' },
    ...
    {Q: 'Usamos estado (state) para __', R: 'dizer para o ReactQuais informaçõesQuando atualizadas devem renderizar a tela novamente' }
];
